...
const cardDataList = [
        ...
        },
        {
                ...
                body: "高校3年<br><br>普段、墨絵という白黒の世界を描いているんですが、それがコロナで閑散として色を失った現状とマッチしていると感じました。そこでコロナが収束して賑わいが戻ることを願い、色を取り入れることにチャレンジしました。後ろから光を当てると色が着く仕組みになっています！描く題材も皆が上を向いていけるようライトアップされる通天閣にしました！この作品が多くの人の目にとまり少しでも明るい気持ちになってほしく応募しました！このような機会を設けていただきありがとうございます！",
